...
with open(os.path.join(ROOT_DIR, 'yumemi', '__init__.py')) as f:
...
latex_documents = [
    (master_doc, 'Yumemi.tex', 'Yumemi Documentation',
...
man_pages = [
    (master_doc, 'Yumemi', 'Yumemi Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Yumemi', 'Yumemi Documentation',
     author, 'Yumemi', 'One line description of project.',
     'Miscellaneous'),
]
